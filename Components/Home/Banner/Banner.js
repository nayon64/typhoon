...
const Banner = () => {
	return (
    <section className="py-2 px-4 grid grid-cols-2">
      ...
      <div className="flex justify-center relative items-center">
        <div className="h-80 overflow-hidden absolute z-20 w-60 left-0 hover:z-40 skew-y-6 hover:skew-y-0 duration-300">
          <img
            className=""
        ...
        <div className="h-96 overflow-hidden w-60 z-30 shadow-lg ">
          <img
            className=""
        ...
        <div className="h-80 overflow-hidden absolute z-20 w-60 right-0 hover:z-40  -skew-y-6 hover:skew-y-0 duration-300">
          <img
